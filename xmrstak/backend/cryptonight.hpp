...
constexpr size_t CRYPTONIGHT_MARKETCASH_MEMORY = 2 * 1024 * 1024;
constexpr uint32_t CRYPTONIGHT_MARKETCASH_MASK = 0x1FFFF0;
constexpr uint32_t CRYPTONIGHT_MARKETCASH_ITER = 0x60000;
...
template<>
inline constexpr size_t cn_select_memory<cryptonight_marketcash>() { return CRYPTONIGHT_MARKETCASH_MEMORY; }
...
inline size_t cn_select_memory(xmrstak_algo algo)
{
	...
	case cryptonight_marketcash:
		return CRYPTONIGHT_MARKETCASH_MEMORY;				
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_marketcash>() { return CRYPTONIGHT_MARKETCASH_MASK; }
...
inline size_t cn_select_mask(xmrstak_algo algo)
{
	...
	case cryptonight_marketcash:
    	return CRYPTONIGHT_MARKETCASH_MASK;
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_marketcash>() { return CRYPTONIGHT_MARKETCASH_ITER; }
...
inline size_t cn_select_iter(xmrstak_algo algo)
{
	...
	case cryptonight_marketcash:
		return CRYPTONIGHT_MARKETCASH_ITER;
